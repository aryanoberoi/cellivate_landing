      ...
      <div className="section-container">
        <div className="page-two-col-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "60px", alignItems: "start" }}>
          <Reveal>
            ...
            <div className="lift-card" style={{ background: "linear-gradient(135deg, #f8f9ff 0%, #fff 100%)", border: "1px solid rgba(0,0,0,0.08)", padding: "24px 28px", borderRadius: "16px", display: "flex", alignItems: "center", gap: "18px" }}>
